# OAuth1
[![GoDoc](https://pkg.go.dev/badge/github.com/onthegit/oauth1.svg)](https://pkg.go.dev/github.com/onthegit/oauth1)
[![Workflow](https://github.com/onthegit/oauth1/actions/workflows/test.yaml/badge.svg)](https://github.com/onthegit/oauth1/actions/workflows/test.yaml?query=branch%3Amain)
...
```
go get github.com/onthegit/oauth1
```

## Docs

Read [GoDoc](https://godoc.org/github.com/onthegit/oauth1)
...
```go
import (
    "github.com/onthegit/oauth1"
    "github.com/onthegit/oauth1/twitter"
)
...
